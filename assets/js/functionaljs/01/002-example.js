...
document.addEventListener('DOMContentLoaded', function (event) {
  ...
  // in babel the backslash is \\ https://github.com/babel/babel/issues/1550#issueomcomment-102529176
  ...
  document.querySelector('.latex-3').insertAdjacentHTML(
    'beforeend', katex.renderToString(el3.getAttribute('data-latex')
  ))
})
